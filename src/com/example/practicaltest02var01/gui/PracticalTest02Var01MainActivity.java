...
public class PracticalTest02Var01MainActivity extends Activity {
		...
		private ButtonClickListener getWeatherForecastButtonClickListener = new ButtonClickListener();
		...
		private class ButtonClickListener implements Button.OnClickListener {
			...
			public void onClick(View view) {
				...
				String infoType = null;
				 switch(view.getId()) {
				 case R.id.bTemp:
					 infoType = Constants.TEMP;
					 break;
				 case R.id.bUmiditate:
					 infoType = Constants.HUMIDITY;
					 break;
				 case R.id.bAll:
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			weatherForecastTextView = (TextView) findViewById(R.id.tvResult);
